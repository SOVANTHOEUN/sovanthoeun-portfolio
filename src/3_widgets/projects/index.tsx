      ...
      <div className="container px-4 mx-auto">
        ...
        >
          {projects.map((project) => (
            <div
              key={project.slug}
              onClick={() => router.push(`/projects/${project.slug}`)} // Updated to use the new router
              className="group block cursor-pointer"
            >
              <motion.div
                variants={projectVariants}
                className="relative bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover-lift cursor-pointer"
              >
